...
# we have to update using list or tuple 
multiples.update([21, 24])# updating the values using list
multiples.update((27, 30))# updating values using tuple
print(multiples)
...
# copy  method is used to copy the items from one set to another
...
# intersection method is used to combine the elements of both the sets
print(multiples2.intersection(multiples3))

# difference method is used to get  the uniqe elements from either of the sets
print(multiples2.difference(multiples3))# shows  the unique items of set 1
print(multiples3.difference(multiples2))# shows  the unique items of set 2

# symmetric-difference method is used to get  the uniqe elements from both the sets
print(multiples2.symmetric_difference(multiples3))# shows  the unique items of set 1
